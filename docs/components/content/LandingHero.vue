<template>
    <div class="w-full flex flex-col items-center justify-center pt-48 mx-auto z-50 h-full bg-[url(images/ui/light-accent.png)] bg-no-repeat bg-right-bottom">
        <h2 class="text-center text-[#CECFD2] font-sans text-base font-semibold">Stay on budget and build wealth without sacrificing your privacy.</h2>
        <h1 class="text-center font-sans text-7xl max-w-3xl font-semibold leading-tight mt-3 text-[#F5F5F6]">An open source alternative to Mint, YNAB, and more.</h1>
        <h3 class="mt-6 font-sans text-center text-[#94969C] text-xl max-w-2xl mx-auto font-normal">Keep investors and their buyers out of your financial data. Own 100% of your data and start building financial wealth.</h3>

        <div class="mt-12 flex items-center justify-center">
            <NuxtLink to="https://github.com/serversideup/financial-freedom" target="_blank" class="flex items-center font-inter text-[#CECFD2] bg-[#161B26] border border-[#333741] rounded-lg font-semibold text-lg mr-3 py-4 px-[22px] shadow-sm">
            ...
            <NuxtLink to="#ff-follow-along" class="font-sans text-lg font-semibold py-4 px-[22px] rounded-lg border border-[#155EEF] bg-[#155EEF] text-white">
                Get Notified
            </NuxtLink>
        </div>
    </div>
