                ...
                <div data-style="clean">
                    ...
                    <div
                        ...
                        class="seva-fields formkit-fields flex flex-col w-full md:w-auto md:flex-row md:justify-center items-center mt-8">
                            ...
                            <button
                                data-element="submit"
                                class="formkit-submit formkit-submit w-full md:w-auto font-sans text-base font-semibold py-[14px] px-[18px] rounded-lg border border-[#155EEF] bg-[#155EEF] text-white">
