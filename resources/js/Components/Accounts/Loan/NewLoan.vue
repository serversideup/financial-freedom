<template>
    <div class="grid grid-cols-1 gap-4 sm:grid-cols-6 sm:col-span-6">
        ...
        <div class="sm:col-span-3">
            ...
            <div class="mt-1 rounded-md shadow-sm">
                <input v-model="form.open_date" v-bind:class="{ 'border-red-500': !validations.open_date.valid }" id="open-date" type="text" class="rounded-md shadow-sm block w-full border-gray-300">
            </div>
