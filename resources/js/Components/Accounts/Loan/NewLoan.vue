  ...
  <div class="grid grid-cols-1 gap-4 sm:col-span-6 sm:grid-cols-6">
    ...
    <div class="sm:col-span-3">
      ...
      <div class="mt-1 rounded-md shadow-sm">
        <input
          ...
          :class="{ 'border-red-500': !validations.open_date.valid }"
          type="text"
          class="block w-full rounded-md border-gray-300 shadow-sm"
        />
      </div>
      <span
        v-show="!validations.open_date.valid"
        class="text-sm text-red-500"
        v-text="validations.open_date.message"
      ></span>
    </div>
    <div class="sm:col-span-3">
      <div>
    ...
    <div class="sm:col-span-3">
      <div>
        ...
        <span
          v-show="!validations.payment_amount.valid"
          class="text-sm text-red-500"
          v-text="validations.payment_amount.message"
        ></span>
      </div>
    </div>
  </div>
...
import LoanAPI from '@/api/loans.js';
...
export default {
  ...
  methods: {
    ...
    validate() {
      ...
      if (this.form.open_date == '') {
        validAccount = false;
        this.validations.open_date.valid = false;
      } else {
      ...
      if (this.form.payment_amount == '') {
        validAccount = false;
        this.validations.payment_amount.valid = false;
      } else {
