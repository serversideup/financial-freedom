                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                <tr v-for="( category, index ) in flattened" :key="'category-'+category.id" >
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                                        <input type="text" class="flex-1 min-w-0 block w-full px-3 py-2 rounded-md focus:ring-blue-500 focus:border-blue-500 sm:text-sm border-gray-300" v-model="flattened[index].name"/>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                        <select id="type" v-model="flattened[index].color" class="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm rounded-md">
                                            <option value=""></option>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        <button type="button" v-on:click="updateCategory( index )" class="text-blue-600 hover:text-blue-900">Update</button>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
