      ...
      tabs: [
        {
          ...
          current: this.active == 'settings',
        },
        {
          name: 'Categories',
          href: '/admin/transactions/categories',
          current: this.active == 'categories',
        },
        {
          name: 'Tags',
          href: '/admin/transactions/tags',
          current: this.active == 'tags',
        },
        {
          name: 'Rules',
          href: '/admin/transactions/rules',
          current: this.active == 'rules',
        },
      ],
    };
  },
