  ...
  <div>
        ...
        <template #form>
          <div class="col-span-6">
            <div class="max-w-xl text-sm text-gray-600">
              Please provide the email address of the person you would like to add to this team. The
              email address must be associated with an existing account.
            </div>
          </div>
          ...
          <div v-if="availableRoles.length > 0" class="col-span-6 lg:col-span-4">
            ...
            <div class="mt-1 cursor-pointer rounded-lg border border-gray-200">
              <div
    ...
    <div v-if="team.users.length > 0">
      ...
      <jet-action-section class="mt-10 sm:mt-0">
        ...
        <template #content>
          <div class="space-y-6">
            <div v-for="user in team.users" class="flex items-center justify-between">
              <div class="flex items-center">
...
export default {
  ...
  methods: {
    ...
    updateRole() {
      this.updateRoleForm
        .put(`/teams/${this.team.id}/members/${this.managingRoleFor.id}`, {
          preserveScroll: true,
        })
        .then(() => {
    ...
    removeTeamMember() {
      this.removeTeamMemberForm
        .delete(`/teams/${this.team.id}/members/${this.teamMemberBeingRemoved.id}`, {
          preserveScroll: true,
          preserveState: true,
        })
        .then(() => {
