<template>
    <div class="flex flex-col items-center justify-center mx-auto w-full rounded-xl border border-[#1F242F] px-6 py-4">
        ...
        <span class="mb-1 text-[#94969C] text-xs font-sans">
            <label for="file-upload" class="font-semibold text-sm font-sans text-[#CECFD2] cursor-pointer">Click to upload
                <input ref="transactionsImportCsv" type="file" id="file-upload" @change="handleFileUpload()" class="sr-only"/>
            </label>
            or drag and drop
        </span>
...
const { file, parseUpload } = useImportTransactions();
