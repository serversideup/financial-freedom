<template>
  ...
  >
    <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
      <div v-if="!transaction.imported" class="flex h-10 items-center justify-between">
        <input v-model="transaction.import" type="checkbox" />
        <span
          v-if="transaction.potential_duplicate != null"
          class="ml-1 cursor-pointer"
          @click="viewDuplicate(transaction, key)"
        >
          <svg
    ...
    <td class="whitespace-nowrap px-3 py-4 text-sm capitalize text-gray-500">
      <span
    ...
    <td class="w-52 whitespace-nowrap px-3 py-4 text-sm text-gray-500">
      <category-select v-if="!transaction.imported" v-model="transaction.category" />
    ...
    <td class="whitespace-nowrap px-3 py-4 text-sm font-bold text-gray-500">
      <span
        :class="{
          'text-red-500': transaction.direction == 'outflow',
          'text-green-500': transaction.direction == 'inflow',
